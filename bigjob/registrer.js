document.getElementById('inscriptionForm').addEventListener('submit', function(event) {
    ...
    // Validation du champ email
    if (!studentlaplateforme(email)) {
        document.getElementById('emailError').textContent = "La création de compte est réservée aux membres de La Plateforme. Veuillez vérifier le domaine associé à votre adresse e-mail.";
        return;
    } else {
        document.getElementById('emailError').textContent = '';
    }
...
function studentlaplateforme(email){
    const laplateformeRegex = /@laplateforme\.io$/;
    return laplateformeRegex.test(email);
}
